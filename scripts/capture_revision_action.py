...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Capture one Agent-authored Stage 6 revision round into revision-master runtime truth.")
...
def main() -> int:
    ...
    db_path = artifact_root / "revision-master.db"
