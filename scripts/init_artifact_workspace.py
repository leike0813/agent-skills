...
DEFAULT_WORKSPACE_NAME = "revision-master-workspace"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Initialize a DB-first runtime artifact workspace for revision-master.")
    parser.add_argument("--artifact-root", help="Target workspace path. If omitted, create revision-master-workspace with auto-numbering.")
