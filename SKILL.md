...
- 以 `revision-master.db` 维持运行时唯一真源
...
- 文件路径：`revision-master/scripts/gate_and_render_workspace.py`
- 标准执行方式：

```bash
conda run --no-capture-output -n DataProcessing python -u \
  revision-master/scripts/gate_and_render_workspace.py \
...
- `revision-master/references/workflow-glossary.md`
...
1. 入口辅助脚本：`revision-master/scripts/detect_main_tex.py`
   - 当 `manuscript_source` 是 LaTeX 工程目录，且主入口需要辅助识别时必须调用
   - 当 `manuscript_source` 已经是单个明确的主 `.tex` 文件时通常不调用

2. 初始化脚本：`revision-master/scripts/init_artifact_workspace.py`
   - 当 workspace 尚未初始化时必须调用
   - 不允许跳过初始化直接假设数据库或视图已就绪

3. `gate-and-render` 核心脚本：`revision-master/scripts/gate_and_render_workspace.py`
   - 统一恢复入口时必须调用
   - 每次正式写库后必须调用
...
1. 运行时唯一真源固定为 artifact workspace 根目录下的 `revision-master.db`。
...
- `revision-master/references/helper-scripts.md`
- `revision-master/references/stage-1-entry-and-bootstrap.md`
...
1. 运行 `revision-master/scripts/gate_and_render_workspace.py`
...
- `revision-master/references/helper-scripts.md`
- `revision-master/references/workflow-state-machine.md`
- `revision-master/references/sql-write-recipes.md`
- `revision-master/assets/runtime/skill-runtime-digest.md`
...
- `revision-master/scripts/detect_main_tex.py`
- `revision-master/scripts/init_artifact_workspace.py`
- `revision-master/scripts/gate_and_render_workspace.py`
...
- `revision-master/references/stage-2-manuscript-analysis.md`
- `revision-master/references/sql-write-recipes.md`
- `revision-master/references/workflow-state-machine.md`
...
- `revision-master/references/stage-3-comment-atomization.md`
- `revision-master/references/workflow-state-machine.md`
- `revision-master/references/sql-write-recipes.md`
...
- `revision-master/references/stage-4-workboard-planning.md`
- `revision-master/references/workflow-state-machine.md`
- `revision-master/references/sql-write-recipes.md`
...
- `revision-master/references/stage-5-strategy-and-execution.md`
- `revision-master/references/workflow-state-machine.md`
- `revision-master/references/sql-write-recipes.md`
...
- `revision-master/scripts/gate_and_render_workspace.py`
- `revision-master/scripts/capture_revision_action.py`
- `revision-master/scripts/commit_revision_round.py`

参考文档：

- `revision-master/references/stage-6-final-review-and-export.md`
- `revision-master/references/workflow-state-machine.md`
- `revision-master/references/sql-write-recipes.md`
